...
module.exports = () => ({
    ...
    rgba: function (...components) {
        return new Color([
            ...
            components[1] / 255,
            components[2] / 255,
            components.length > 3 ? components[4] : 1
        ]);
    },

    interpolate: {
        number: interpolate.number,
        color: function(from, to, t) {
            const result = interpolate.color(from.value, to.value, t);
     ...
     * @private
    */
    interpolationFactor: function(input, base, lowerValue, upperValue) {
     ...
     * @private
     */
    findStopLessThanOrEqualTo: function(stops, input) {
